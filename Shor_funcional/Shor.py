...
class Shor:
    ...
    def __init__(
        ...
        self._quantum_instance = quantum_instance if quantum_instance else QuantumInstance(Aer.get_backend('qasm_simulator'))
    ...
    def _power_mod_N(self, n: int, N: int, a: int) -> Instruction:
        ...
        return circuit.to_instruction(label=f"mult mod {N}")
    ...
    def _validate_input(N: int, a: int):
        ...
        validate_min("N", N, 3)
        validate_min("a", a, 2)
        print("El N es:"+ str(N)+"y el a es:"+str(a))
        #print(a)
        #print(a >= N or math.gcd(a, N) != 1)
        if N < 1 or N % 2 == 0:
    ...
    def factor(
        ...
        if not result.factors:
            ...
            if self._quantum_instance.is_statevector:
                ...
                counts = self._quantum_instance.execute(circuit).get_counts(circuit)    #antes 
